...
static const unsigned char  IM__MIN  = 0;
static const unsigned char  IM__MAX  = 0xFF;
...
int ImGui::DataTypeFormatString(char* buf, int buf_size, ImGuiDataType data_type, const void* p_data, const char* format)
{
    ...
    if (data_type == ImGuiDataType_)
        return ImFormatString(buf, buf_size, format, *(const Im*)p_data);
...
void ImGui::DataTypeApplyOp(ImGuiDataType data_type, int op, void* output, const void* arg1, const void* arg2)
{
    ...
    switch (data_type)
    {
        case ImGuiDataType_S8:
            ...
            return;
        case ImGuiDataType_:
            if (op == '+') { *(Im*)output  = ImAddClampOverflow(*(const Im*)arg1,  *(const Im*)arg2,  IM__MIN,  IM__MAX); }
            if (op == '-') { *(Im*)output  = ImSubClampOverflow(*(const Im*)arg1,  *(const Im*)arg2,  IM__MIN,  IM__MAX); }
            return;
...
bool ImGui::DataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* format)
{
    ...
    if (type_info->Size < 4)
    {
        ...
        else if (data_type == ImGuiDataType_)
            *(Im*)p_data = (Im)ImClamp(v32, (int)IM__MIN, (int)IM__MAX);
...
int ImGui::DataTypeCompare(ImGuiDataType data_type, const void* arg_1, const void* arg_2)
{
    ...
    case ImGuiDataType_:     return DataTypeCompareT<Im  >((const Im*  )arg_1, (const Im*  )arg_2);
...
bool ImGui::DataTypeClamp(ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max)
{
    ...
    case ImGuiDataType_:     return DataTypeClampT<Im  >((Im*  )p_data, (const Im*  )p_min, (const Im*  )p_max);
...
bool ImGui::DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    case ImGuiDataType_:     { ImU32 v32 = (ImU32)*(Im*)p_v;  bool r = DragBehaviorT<ImU32, ImS32, float>(ImGuiDataType_U32, &v32, v_speed, p_min ? *(const Im*) p_min : IM__MIN,  p_max ? *(const Im*)p_max  : IM__MAX,  format, flags); if (r) *(Im*)p_v = (Im)v32; return r; }
...
bool ImGui::SliderBehavior(const ImRect& bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb)
{
    ...
    case ImGuiDataType_:  { ImU32 v32 = (ImU32)*(Im*)p_v;  bool r = SliderBehaviorT<ImU32, ImS32, float>(bb, id, ImGuiDataType_U32, &v32, *(const Im*)p_min,  *(const Im*)p_max,  format, flags, out_grab_bb); if (r) *(Im*)p_v  = (Im)v32;  return r; }
