...
static void TableSetupColumnFlags(ImGuiTable* table, ImGuiTableColumn* column, ImGuiTableColumnFlags flags_in)
{
    ...
    if (table->Flags & ImGuiTableFlags_Sortable)
    {
        ...
        column->SortDirectionsAvailList = (Im)list;
        column->SortDirectionsAvailMask = (Im)mask;
        column->SortDirectionsAvailCount = (Im)count;
...
void ImGui::TableSetupColumn(const char* label, ImGuiTableColumnFlags flags, float init_width_or_weight, ImGuiID user_id)
{
    ...
    if (table->IsInitializing)
    {
        ...
        if (flags & ImGuiTableColumnFlags_DefaultSort && (table->SettingsLoadedFlags & ImGuiTableFlags_Sortable) == 0)
        {
            ...
            column->SortDirection = (column->Flags & ImGuiTableColumnFlags_PreferSortDescending) ? (ImS8)ImGuiSortDirection_Descending : (Im)(ImGuiSortDirection_Ascending);
        }
    }
...
void ImGui::TableFixColumnSortDirection(ImGuiTable* table, ImGuiTableColumn* column)
{
    if (column->SortOrder == -1 || (column->SortDirectionsAvailMask & (1 << column->SortDirection)) != 0)
        return;
    column->SortDirection = (Im)TableGetColumnAvailSortDirection(column, 0);
    table->IsSortSpecsDirty = true;
}
...
void ImGui::TableSetColumnSortDirection(int column_n, ImGuiSortDirection sort_direction, bool append_to_sort_specs)
{
    ...
    ImGuiTableColumn* column = &table->Columns[column_n];
    column->SortDirection = (Im)sort_direction;
...
static void TableSettingsHandler_ReadLine(ImGuiContext*, ImGuiSettingsHandler*, void* entry, const char* line)
{
    ...
    if (sscanf(line, "Column %d%n", &column_n, &r) == 1)
    {
        ...
        if (sscanf(line, "Visible=%d%n", &n, &r) == 1)          { line = ImStrSkipBlank(line + r); column->IsEnabled = (Im)n; settings->SaveFlags |= ImGuiTableFlags_Hideable; }
